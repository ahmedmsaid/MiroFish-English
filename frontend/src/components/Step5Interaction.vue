          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select Interaction Target</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat version of the report generation agent, capable of calling 4 types of professional tools and possessing full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation environment states, combining Global/Local Memory mechanisms to provide cross-temporal deep attribution analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Breadth-first traversal algorithm based on graph structure, reconstructing event propagation paths and capturing the topological structure of full information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Instant query interface based on GraphRAG, optimizing indexing efficiency for fast extraction of specific node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewing, capable of conducting multi-round parallel conversations with individuals in the simulated world to collect unstructured viewpoint data and psychological states.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to learn more about the report content.' : 'Chat with simulated individuals to understand their perspectives.' }}
              </p>
            </div>
            <div 
...
const selectAgent = (agent, idx) => {
  ...
  // Restore Agent chat records
  chatHistory.value = chatHistoryCache.value[`agent_${idx}`] || []
  addLog(`Select interaction target: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> followed by block-level elements (due to extra empty lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean <br> before paragraph start tag followed by block-level element
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering for non-consecutive ordered lists: when single <ol> items are separated by paragraph content, maintain incrementing numbering
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prefer getting reddit platform replies
    const responseContent = null
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('Report data loading complete')
    }
  } catch (err) {
    addLog(`Loading report log failed: ${err.message}`)
  }
}
...
/* Fix ordered list numbering - use CSS counter to let multiple ols have continuous numbering */
.message-text {
