    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else class="badge processing">Initial</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a new simulation instance and pull simulation world parameter templates.
          </p>
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              <span class="info-label">Apparent event MBTI</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Combining context, automatically call tools to organize entities and relationships from the knowledge graph, initialize simulated individuals, and endow them with unique behaviors and memories based on reality seeds.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Reality Seed Current Associated Topics</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently sets parameters such as world time flow rate, recommendation algorithms, active periods for each individual, posting frequency, and event triggers based on simulation requirements and reality seeds.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Recommender Algorithm Config</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The simulation environment is ready, and you can now start the simulation.</p>
          
          <!-- Simulation Round Config - only show after config is generated and rounds are calculated -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Round Setting</span>
                <span class="section-desc">MiroFish automatically plans to deduce <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours in reality, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of reality time passing</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>For an agent scale of 100: Estimated time approx. {{ Math.round(customMaxRounds * 0.6) }} min</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        For an agent scale of 100: Estimated time {{ Math.round(autoGeneratedRounds * 0.6) }} min
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If running for the first time, it is highly recommended to switch to 'Custom Mode' and reduce simulation rounds for a quick preview and lower risk of errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Apparent event age</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} yrs</span>
            </div>
            <div class="info-item">
              <span class="info-label">Apparent event gender</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Summary of experience and behavioral style preferences</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Individual connection and interaction graph</span>
              </div>
            </div>
...
// State
const phase = ref(0) // 0: Init, 1: Profile Generation, 2: Config Generation, 3: Complete
...
const useCustomRounds = ref(false) // Default use auto rounds
...
// Calculate auto rounds from config (not using hardcoded defaults)
const autoGeneratedRounds = computed(() => {
  ...
  if (!totalHours || !minutesPerRound) {
    return null // Return null if config incomplete
  }
  const calculatedRounds = Math.floor((totalHours * 60) / minutesPerRound)
  // Ensure max rounds not less than 40 (recommended)
...
const handleStartSimulation = () => {
  // Build parameters to pass to parent
  const params = {}
  
  if (useCustomRounds.value) {
    // Custom rounds, pass maxRounds param
    params.maxRounds = customMaxRounds.value
    addLog(`Starting simulation, custom rounds: ${customMaxRounds.value} rounds`)
  } else {
    // Auto-generated rounds, don't pass maxRounds param
...
const startPrepareSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Set expected total agents (from prepare interface response)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog('Config generating, starting polling wait...')
        startConfigPolling()
      }
    }
  } catch (err) {
