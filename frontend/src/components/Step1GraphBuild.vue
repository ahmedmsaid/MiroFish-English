    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are automatically chunked and Zep is called to build a knowledge graph, extracting entities and relationships, and forming temporal memories and community summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Construction Completed</span>
          </div>
          <div class="step-status">
...
// Enter environment setup - create simulation and jump
