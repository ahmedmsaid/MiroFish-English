    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
                ...
                <button class="action-btn" @click="toggleFullScreen" :title="isFullScreen ? 'Exit Full Screen' : 'Full Screen Display'">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph Visualization (shown if data exists) -->
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-text">Constructing Graph</p>
      ...
      <!-- Right: Construction Flow Details -->
      <div class="right-panel" :class="{ 'hidden': isFullScreen }">
        <div class="panel-header dark-header">
          <span class="header-icon">▣</span>
          <span class="header-title">Construction Flow</span>
        </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes content to automatically generate an ontology structure suitable for opinion simulation (Entity Types + Relation Types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and Zep API is called to build a knowledge graph, extracting entities and relationships
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 2, 'completed': currentPhase > 2 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                ...
                <div class="phase-api">Preparing for the next step</div>
              </div>
...
const currentPhase = ref(-1) // -1: Uploading, 0: Ontology generating, 1: Graph construction, 2: Completed
...
const initProject = async () => {
  ...
  if (paramProjectId === 'new') {
    // New project: get data to be uploaded from store
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files to upload, please return to the home page'
    loading.value = false
    return
  }
...
const startPollingTask = (taskId) => {
  // Perform query immediately once
