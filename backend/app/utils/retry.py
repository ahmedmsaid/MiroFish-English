...
def retry_with_backoff(
    ...
    Args:
        ...
        on_retry: Callback function during retry (exception, retry_count)
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logger.warning(
                        ...
                        f"{current_delay:.1f} seconds later retrying..."
                    )
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        Args:
            ...
            process_func: Processing function, receiving single item as argument
            exceptions: Exception types that need to be retried
