...
def chat_with_report_agent():
    ...
    Report Agent can autonomously call retrieval tools in the dialogue to answer questions
    
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",        // Required, simulation ID
            "message": "Please explain the current sentiment trend",    // Required, user message
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this interface to get generated section content without waiting for the whole report completion
...
def check_report_status(simulation_id: str):
    ...
    Used for frontend to determine whether to unlock Interview feature
...
def get_console_log(report_id: str):
    """
    Get console output logs for Report Agent
    
    Real-time retrieval of console output (INFO, WARNING, etc.) during report generation,
    different from structured JSON logs returned by the agent-log interface,
