...
Reads nodes from Zep graph and filters for those matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: Function to execute (lambda or callable without arguments)
            operation_name: Operation name for logging
            max_retries: Maximum number of retries (default 3, i.e. 3 attempts total)
    ...
    def filter_defined_entities(
        ...
        Filtering Logic:
        - If a node has only "Entity" in Labels, it doesn't match predefined types, skip
        - If Labels contains tags other than "Entity" and "Node", it matches predefined types, keep
