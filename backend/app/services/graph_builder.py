...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is the usage required by Zep SDK, the warning comes from dynamic class creation, it can be safely ignored
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # Zep API requires description for Field, this is required
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API requires description for Field, this is required
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  # Edge properties use str type
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to complete processing (by querying the processed status of each episode)"""
        ...
        if progress_callback:
            progress_callback(f"Start waiting for {total_episodes} text blocks to process...", 0)
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges, including time information, attributes, etc.
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
