...
class SimulationManager:
    ...
    def __init__(self):
        ...
        # Simulation state cache in memory
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation configuration parameters (timing, activity, frequency, etc.)
        ...
        try:
            ...
            # Set file path for real-time saving (priority to Reddit JSON format)
            ...
            # ========== Stage 3: LLM Intelligent Configuration Generation ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0, 
            ...
            # When starting simulation, simulation_runner will run weights from scripts/ directory
