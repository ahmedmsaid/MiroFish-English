...
if os.path.exists(project_root_env):
    ...
    # If .env is not in the root directory, try loading environment variables (for production)
...
class Config:
    ...
    # JSON configuration - Disable ASCII escaping to allow direct display of Unicode characters
    JSON_AS_ASCII = False
